...
if isfield( handles, 'temp_arena' )
   if isfield(handles.temp_arena, 'center_x')
      [cc, rr] = meshgrid( c0:c1, r0:r1 );
      non_arena_mask = sqrt( ...
      ...
      handles.im(:,(c0:c1) < handles.temp_arena.upper_left(1)) = 0;
      handles.im(:,(c0:c1) > handles.temp_arena.lower_right(1)) = 0;
      handles.im((r0:r1) < handles.temp_arena.upper_left(2),:) = 0;
      handles.im((r0:r1) > handles.temp_arena.lower_right(2),:) = 0;
   end
end
