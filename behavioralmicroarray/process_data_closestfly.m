...
for fly1 = 1:nflies,
   ...
   if isdummytrk( trx(fly1 ) ), continue, end
  ...
  for fly2 = 1:nflies,
    ...
    if isdummytrk( trx(fly2 ) ), continue, end
    ...
    fly2_i0 = max( [i0, trx(fly2).firstframe] );
    fly2_i1 = min( [i1, trx(fly2).endframe] );
    i_rng = fly2_i0:fly2_i1;
    anglefrom2to1(fly2,i_rng) = modrange(atan2(-dy,-dx)-trx(fly2).theta(i_rng - trx(fly2).firstframe + 1),-pi,pi);
