function varargout = showmanybehaviors(varargin)
% [starts,ends] = showmanybehaviors(trx,fly,moviename)

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @showmanybehaviors_OpeningFcn, ...
                   'gui_OutputFcn',  @showmanybehaviors_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before showmanybehaviors is made visible.
function showmanybehaviors_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to showmanybehaviors (see VARARGIN)
...
% UIWAIT makes showmanybehaviors wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = showmanybehaviors_OutputFcn(hObject, eventdata, handles) 
...
if handles.isseg(i) > 0,
  ...
  if ~strcmp(handles.behaviorcurr,handles.labels{j}),
    ...
    set(handles.labeltext,'String',handles.behaviorcurr,'BackgroundColor',handles.behaviorcolors(handles.behaviorvalue,:));
  end
...
% --- Executes on button press in labeltext.
